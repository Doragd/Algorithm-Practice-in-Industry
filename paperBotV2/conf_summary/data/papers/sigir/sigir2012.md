...
| --- | --- | --- | --- | --- | --- | --- |
|  |  [Personalized click shaping through lagrangian duality for online recommendation](https://doi.org/10.1145/2348283.2348350) |  | 0 |  | Deepak Agarwal, BeeChung Chen, Pradheep Elango, Xuanhui Wang |  |
|  |  [Beyond bag-of-words: machine learning for query-document matching in web search](https://doi.org/10.1145/2348283.2348528) |  | 0 |  | Hang Li, Jun Xu |  |
|  |  [Adaptation of the concept hierarchy model with search logs for query recommendation on intranets](https://doi.org/10.1145/2348283.2348288) |  | 0 |  | Ibrahim Adepoju Adeyanju, Dawei Song, MDyaa Albakour, Udo Kruschwitz, Anne N. De Roeck, Maria Fasli |  |
|  |  [Collaborative personalized tweet recommendation](https://doi.org/10.1145/2348283.2348372) |  | 0 |  | Kailong Chen, Tianqi Chen, Guoqing Zheng, Ou Jin, Enpeng Yao, Yong Yu |  |
|  |  [Modeling the impact of short- and long-term behavior on search personalization](https://doi.org/10.1145/2348283.2348312) |  | 0 |  | Paul N. Bennett, Ryen W. White, Wei Chu, Susan T. Dumais, Peter Bailey, Fedor Borisyuk, Xiaoyuan Cui |  |
|  |  [Personalization of search results using interaction behaviors in search sessions](https://doi.org/10.1145/2348283.2348314) |  | 0 |  | Chang Liu, Nicholas J. Belkin, Michael J. Cole |  |
|  |  [Queries without clicks: evaluating retrieval effectiveness based on user feedback](https://doi.org/10.1145/2348283.2348505) |  | 0 |  | Athanasia Koumpouri, Vasiliki Simaki |  |
|  |  [Learning to suggest: a machine learning framework for ranking query suggestions](https://doi.org/10.1145/2348283.2348290) |  | 0 |  | Umut Ozertem, Olivier Chapelle, Pinar Donmez, Emre Velipasaoglu |  |
|  |  [Explicit relevance models in intent-oriented information retrieval diversification](https://doi.org/10.1145/2348283.2348297) |  | 0 |  | Saul Vargas, Pablo Castells, David Vallet |  |
|  |  [Retrieving similar discussion forum threads: a structure based approach](https://doi.org/10.1145/2348283.2348305) |  | 0 |  | Amit Singh, Deepak P, Dinesh Raghu |  |
|  |  [An exploration of ranking heuristics in mobile local search](https://doi.org/10.1145/2348283.2348325) |  | 0 |  | Yuanhua Lv, Dimitrios Lymberopoulos, Qiang Wu |  |
|  |  [Predicting the ratings of multimedia items for making personalized recommendations](https://doi.org/10.1145/2348283.2348349) |  | 0 |  | Rani Qumsiyeh, YiuKai Ng |  |
|  |  [Automatic term mismatch diagnosis for selective query expansion](https://doi.org/10.1145/2348283.2348354) |  | 0 |  | Le Zhao, Jamie Callan |  |
|  |  [Modeling higher-order term dependencies in information retrieval using query hypergraphs](https://doi.org/10.1145/2348283.2348408) |  | 0 |  | Michael Bendersky, W. Bruce Croft |  |
|  |  [The essence of time: considering temporal relevance as an intent-aware ranking problem](https://doi.org/10.1145/2348283.2348424) |  | 0 |  | Stewart Whiting |  |
|  |  [Exploring tag relevance for image tag re-ranking](https://doi.org/10.1145/2348283.2348473) |  | 0 |  | Jie Xiao, Wengang Zhou, Qi Tian |  |
|  |  [Fixed versus dynamic co-occurrence windows in TextRank term weights for information retrieval](https://doi.org/10.1145/2348283.2348478) |  | 0 |  | Wei Lu, Qikai Cheng, Christina Lioma |  |
|  |  [Re-examining search result snippet examination time forrelevance estimation](https://doi.org/10.1145/2348283.2348509) |  | 0 |  | Dmitry Lagun, Eugene Agichtein |  |
|  |  [User-aware caching and prefetching query results in web search engines](https://doi.org/10.1145/2348283.2348520) |  | 0 |  | Hongyuan Ma, Bin Wang |  |
|  |  [Medical information retrieval: an instance of domain-specific search](https://doi.org/10.1145/2348283.2348537) |  | 0 |  | Allan Hanbury |  |
|  |  [Patent information retrieval: an instance of domain-specific search](https://doi.org/10.1145/2348283.2348536) |  | 0 |  | Mihai Lupu |  |
|  |  [The 35th International ACM SIGIR conference on research and development in Information Retrieval, SIGIR '12, Portland, OR, USA, August 12-16, 2012](https://doi.org/10.1145/2348283) |  | 0 |  | William R. Hersh, Jamie Callan, Yoelle Maarek, Mark Sanderson |  |
|  |  [Retrieving information from the book of humanity: the personalized medicine data tsunami crashes on the beach of jeopardy](https://doi.org/10.1145/2348283.2348286) |  | 0 |  | Daniel R. Masys |  |
|  |  [Combining inverted indices and structured search for ad-hoc object retrieval](https://doi.org/10.1145/2348283.2348304) |  | 0 |  | Alberto Tonon, Gianluca Demartini, Philippe CudréMauroux |  |
|  |  [To index or not to index: time-space trade-offs in search engines with positional ranking functions](https://doi.org/10.1145/2348283.2348320) |  | 0 |  | Diego Arroyuelo, Senén González, Mauricio Marín, Mauricio Oyarzún, Torsten Suel |  |
|  |  [Mining query subtopics from search log data](https://doi.org/10.1145/2348283.2348327) |  | 0 |  | Yunhua Hu, Yanan Qian, Hang Li, Daxin Jiang, Jian Pei, Qinghua Zheng |  |
|  |  [Efficient query recommendations in the long tail via center-piece subgraphs](https://doi.org/10.1145/2348283.2348332) |  | 0 |  | Francesco Bonchi, Raffaele Perego, Fabrizio Silvestri, Hossein Vahabi, Rossano Venturini |  |
|  |  [Fighting against web spam: a novel propagation method based on click-through data](https://doi.org/10.1145/2348283.2348338) |  | 0 |  | Chao Wei, Yiqun Liu, Min Zhang, Shaoping Ma, Liyun Ru, Kuo Zhang |  |
|  |  [Automatic suggestion of query-rewrite rules for enterprise search](https://doi.org/10.1145/2348283.2348363) |  | 0 |  | Zhuowei Bao, Benny Kimelfeld, Yunyao Li |  |
|  |  [Prefetching query results and its impact on search engines](https://doi.org/10.1145/2348283.2348368) |  | 0 |  | Simon Jonassen, Berkant Barla Cambazoglu, Fabrizio Silvestri |  |
|  |  [Mixture model with multiple centralized retrieval algorithms for result merging in federated search](https://doi.org/10.1145/2348283.2348393) |  | 0 |  | Dzung Hong, Luo Si |  |
...
|  |  [Incorporating statistical topic information in relevance feedback](https://doi.org/10.1145/2348283.2348485) |  | 0 |  | Karla L. Caballero Espinosa, Ram Akella |  |
...
|  |  [When web search fails, searchers become askers: understanding the transition](https://doi.org/10.1145/2348283.2348390) |  | 0 |  | Qiaoling Liu, Eugene Agichtein, Gideon Dror, Yoelle Maarek, Idan Szpektor |  |
...
|  |  [Impact of assessor disagreement on ranking performance](https://doi.org/10.1145/2348283.2348484) |  | 0 |  | Pavel Metrikov, Virgiliu Pavlu, Javed A. Aslam |  |
...
|  |  [Finding web appearances of social network users via latent factor model](https://doi.org/10.1145/2348283.2348477) |  | 0 |  | Kailong Chen, Zhengdong Lu, Xiaoshi Yin, Yong Yu, Zaiqing Nie |  |
...
|  |  [Effect of written instructions on assessor agreement](https://doi.org/10.1145/2348283.2348465) |  | 0 |  | William Webber, Bryan Toth, Marjorie Desamito |  |
